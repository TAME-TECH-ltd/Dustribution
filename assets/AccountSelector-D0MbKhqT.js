import{n as o}from"./index-C9YQfvNT.js";const r={name:"AccountSelector",props:["group","value","excludes","records","fetchOnLoad"],components:{AccountsList:{name:"AccountsList",components:{},props:["rows","spaces","activeItem","excluded"],emits:["selected"],methods:{createWhitespace(c){return"&nbsp;".repeat(c)}},template:`

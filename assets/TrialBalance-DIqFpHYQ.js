import{n as c,d as n,a as d}from"./index-D3VAOaYz.js";import"./vue-BF0JTnD1.js";import"./apexcharts-Bw_a_uVR.js";const m={name:"TrialBalance",mixins:[n],components:{AccountRow:{name:"AccountRow",mixins:[n],components:{AccountRow:void 0},props:["row","spaces"],methods:{formatBalance(a){return a>0?a:-a},filterChildren(a=[]){return a.filter(t=>t.balance!=0)}},template:`
      <div style="display: contents">
        <tr>
          <td class="text-start">
            <RouterLink class="ember-view" :to="viewDetails(row.row_number)"
        ...
        `},SixColumnsRow:{name:"SixColumnsRow",mixins:[n],components:{SixColumnsRow:void 0},props:["row"],methods:{formatBalance(a){return a>0?a:-a},filterChildren(a=[]){return a.filter(t=>t.balance!=0)}},template:`
      <div style="display: contents">
        <tr>

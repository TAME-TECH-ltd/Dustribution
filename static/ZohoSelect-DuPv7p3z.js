import{r as c,V as U,E as y,w as q,o as G,e as b,i as f,z as Z,G as Q,y as A,j as X,I as J,F as Y,q as ee,f as w}from"./vue-DivMTRp2.js";import{t as $,b as E,u as I,_ as te,w as ae,x as le,m as oe,e as se,y as re}from"./app-init-DVMPEvAs.js";const S=c(!1),ne=c(),ie=r=>{S.value=!S.value,ne.value=r,setTimeout(()=>S.value=!S.value,3e3)},K=c(!1),C=U({today:new Date().toLocaleString("fr-CA").slice(0,10)}),ce=r=>{const n=document.createElement("div");n.setAttribute("id","alert-container");const p=` <div

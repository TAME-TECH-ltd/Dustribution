import{d as N}from"./datatable-mixin-DngGIgOt.js";import{O as z}from"./OffCanvas-B7-EV6XL.js";import{Z as q}from"./ZohoSelect-DTL6nO7h.js";import{e as c,i as e,k as x,j as I,u as w,v as S,F,q as B,l,c as P,f as m,z as L,A as H,p as V,x as O}from"./vue-CVFchrEh.js";import{_ as U}from"./app-init-BNM-tVMr.js";import"./ReportHeader-DfgTceP0.js";import"./PeriodPicker-3iK8PLYp.js";import"./jspdf-DpYPBzJl.js";import"./html2canvas-Ge7aVWlp.js";import"./exceljs-D_3E_aRU.js";const W={async handlePrintFrame(t,o={}){try{const{landscape:n=!1,margin:g="10mm",pageSize:v="A4",title:d="Print Document",onBeforePrint:r=null,onAfterPrint:a=null,includeSignature:i=!1,customCSS:u="",watermark:s=null,printerType:f="standard",posOptions:y={width:"80mm",fontSize:"12px",fontFamily:"monospace",lineHeight:"1.4",padding:"5mm"}}=o,_=document.querySelector(t);if(!_)throw new Error(`Element "${t}" not found`);let p=document.querySelector("#printFrame");p||(p=document.createElement("iframe"),p.id="printFrame",p.style.cssText="position:absolute;width:0;height:0;border:none;",document.body.appendChild(p));let b="",E="";f==="standard"&&(document.querySelectorAll("style").forEach(h=>{b+=h.innerHTML}),document.querySelectorAll('link[rel="stylesheet"]').forEach(h=>{E+=`<link rel="stylesheet" href="${h.href}">`}));const $=f.startsWith("pos");let k=y.width;f==="pos-80mm"||f==="pos"?k="80mm":f==="pos-58mm"&&(k="58mm"),$?b+=`
                        * {
                            margin: 0;
                            padding: 0;

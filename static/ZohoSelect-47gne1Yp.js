import{r as c,U,D as _,w as P,o as z,e as y,i as f,z as H,E as Z,y as q,j as G,I as Q,F as X,q as J,f as b}from"./vue-CxvhVBJU.js";import{q as R,b as $,t as V,_ as W,u as Y,w as ee,m as te,e as ae,x as le}from"./app-init-kFI3CKPD.js";const w=c(!1),oe=c(),se=n=>{w.value=!w.value,oe.value=n,setTimeout(()=>w.value=!w.value,3e3)},E=c(!1),T=U({today:new Date().toLocaleString("fr-CA").slice(0,10)}),ne=n=>{const r=document.createElement("div");r.setAttribute("id","alert-container");const p=` <div

import{A as y}from"./chunk-KYHALAMY.js";import{f as b}from"./chunk-RA6JZYLY.js";import{Ic as u,M as d,Q as h,U as l}from"./chunk-E6BPGTFR.js";var c={production:!0,webUrl:"/bkend/",baseURL:"/bkend/api/",uploadsURL:"/bkend/uploads/",inventoryPath:"",publicPath:"/lodging-services/#/"};var R=(()=>{let i=class i{constructor(e,t,a){this.apiService=e,this.router=t,this.http=a}confirm(e){let t=document.createElement("div");t.setAttribute("id","alert-container");let a=` <div
    ...
    `:"";s.write('<body onload="window.print();"><div class="v-application v-application--is-ltr theme--light print_report">'+f.outerHTML+w+"</div></body></html>"),s.close()}closeWorkingDay(){return this.http.get("settings/close-working-day").pipe(d(e=>{this.preloaders.system_date=e.system_date,this.preloaders.isDayActive=!0}))}};i.\u0275fac=function(t){return new(t||i)(l(y),l(b),l(u))},i.\u0275prov=h({token:i,factory:i.\u0275fac,providedIn:"root"});let r=i;return r})();export{c as a,R as b};
